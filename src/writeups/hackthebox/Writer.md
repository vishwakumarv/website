...
![writer](/images/writeups/hackthebox/Writer/writer.png)
...
![storybank](/images/writeups/hackthebox/Writer/storybank.png)

About page:

![about-page](/images/writeups/hackthebox/Writer/about-page.png)
...
![smb-listing](/images/writeups/hackthebox/Writer/smb-listing.png)
...
![null-session-rpcclient-smb](/images/writeups/hackthebox/Writer/null-session-rpcclient-smb.png)
...
![enum-user-from-rpcclient-null-session](/images/writeups/hackthebox/Writer/enum-user-from-rpcclient-null-session.png)
...
![hydra-result](/images/writeups/hackthebox/Writer/hydra-result.png)
...
![file-by-filter-group](/images/writeups/hackthebox/Writer/file-by-filter-group.png)

Checking the content of ` /etc/postfix/disclaimer `

![content-of-disclaimer](/images/writeups/hackthebox/Writer/content-of-disclaimer.png)
...
![write-permission-disclaimer](/images/writeups/hackthebox/Writer//write-permission-disclaimer.png)
...
![reverse-shell](/images/writeups/hackthebox/Writer/reverse-shell.png)
...
![management-group](/images/writeups/hackthebox/Writer/management-group.png)
...
![folder-management-group](/images/writeups/hackthebox/Writer/folder-management-group.png)
...
![root-reverse-shell](/images/writeups/hackthebox/Writer/root-reverse-shell.png)
